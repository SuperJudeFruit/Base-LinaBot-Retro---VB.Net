Public Module Variable
    ...
    Public Delegate Sub DlgPlayer(index As Integer, data As String)
    Public Delegate Sub DlgPlayerAll()
    Public Delegate Function DlgFPlayer(index As Integer, data As String)
    Public Delegate Function DlgFPlayerAll()

    Public PathMitm As String
    Public PathHost As String
    ...
    Public Compteur_Compte As Integer
    Public ListOfBotName As New List(Of String)

    Friend VarServeur As New Dictionary(Of String, ClassServeur)
    Public VarSort As New Dictionary(Of Integer, Dictionary(Of Integer, Sort_Variable.Information))
